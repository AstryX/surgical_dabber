...
if ((bool_should_normalize == True) and (bool_do_normalization_display == True)):
    ...
    #disp_combined = cv2.cvtColor(disp_combined, cv2.COLOR_RGB2BGR)
...
before = loadPointCloud(im_path+'pc_mock/before.PCD', image_size_rows, image_size_cols)
after = loadPointCloud(im_path+'pc_mock/after.PCD', image_size_rows, image_size_cols)
